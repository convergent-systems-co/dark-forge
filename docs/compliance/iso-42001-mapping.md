...
| 5.3 Roles and responsibilities | Five agentic personas with defined boundaries; CODEOWNERS for approval authority; agent protocol for communication | `governance/personas/agentic/`, `CODEOWNERS`, `governance/prompts/agent-protocol.md` |
...
| 7.2 Competence | 19 specialized review perspectives with full evaluation criteria; five agentic personas with domain expertise | `governance/prompts/reviews/`, `governance/prompts/shared-perspectives.md` |
