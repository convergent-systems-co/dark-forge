Run a governance review panel. Argument routing based on user input after the command:
...
1. Scan for review prompts: `.ai/governance/prompts/reviews/*.md`.
2. For each file:
...
1. Read `.ai/governance/prompts/shared-perspectives.md`.
...
5. Read the panel prompt: `.ai/governance/prompts/reviews/<panel>.md`.
