Quick issue triage and planning without the full startup loop. Argument routing based on user input after the command:
...
6. Read plan template: `.ai/governance/prompts/templates/plan-template.md`.
