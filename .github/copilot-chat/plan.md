Manage governance plans. Argument routing based on user input after the command:
...
7. Read the plan template: `.ai/governance/prompts/templates/plan-template.md`.
